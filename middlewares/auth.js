...
function restrictAccess(app, UserModel, allowed_users) {
    ...
    return async function (req, res, next) {
        ...
        if ((allowed_users.includes("hod") || allowed_users.includes("dean") || allowed_users.includes("studentcoordinator") || allowed_users.includes("volunteer") || allowed_users.includes("participant")) && !authenticated) {
